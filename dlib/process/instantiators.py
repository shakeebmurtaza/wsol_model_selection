...
# from dlib.div_classifiers.sat import get_sat_params_for_opt
...
def get_pretrainde_classifier(args):
    ...
    if args.method in spec_mth:
        if args.method == constants.METHOD_ACOL:
        ...
        elif args.method == constants.METHOD_SCM:
            model = create_model(
            task=args.task,
            arch=p.arch,
            method=args.method,
            ...
            encoder_weights=encoder_weights,
            num_classes=args.num_classes,
            drop_rate=args.scm_drop_rate,
            drop_path_rate=args.scm_drop_path,
            # drop_block_rate=None,
            )
        elif args.method == constants.METHOD_NLCCAM:
            model = create_model(
            task=args.task,
            arch=p.arch,
            method=args.method,
...
def get_model(args, eval=False):
    ...
    if args.task == constants.STD_CL:
        ...
        if args.method in spec_mth:
            ...
            if args.method == constants.METHOD_ACOL:
                ...
                num_classes=args.num_classes,
                drop_rate=args.scm_drop_rate,
                drop_path_rate=args.scm_drop_path_rate,
                # drop_block_rate=None,
                )
            elif args.method == constants.METHOD_NLCCAM:
                model = create_model(
    ...
    if eval:
        ...
        tag = get_tag(args, 'models', checkpoint_type=args.eval_checkpoint_type)
...
def _get_model_params_for_opt(args, model):
    ...
    # if args.method == constants.METHOD_SAT:
    #     return get_sat_params_for_opt(hparams, model)
