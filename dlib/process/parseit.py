...
def get_args(args: dict, eval=False):
    ...
    parser.add_argument('--metadata_roots_pseduo_boxs_valset', type=json.loads, default={})
    ##################################################
    ...
    #################FOR Ablations
    parser.add_argument('--ablation_model_sele_l2_norm', type=str2bool, default=None,
                        help='Ablation: if true, we will selected model based on l2 norm of weigts.')
    parser.add_argument('--ablation_model_sele_map_area', type=str2bool, default=None,
                        help='Ablation: if true, we will select using area of when stabalizes over a window accross epochs.')
    parser.add_argument('--abl_sele_map_area_var_window', type=int, default=None,
                        help='Ablation: window size (over epochs) for area variance.')
    #################For ablations
