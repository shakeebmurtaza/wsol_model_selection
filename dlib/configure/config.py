...
def get_config(ds):
    ...
    args = {
        ...
        #############################
        # Meta-data for pseudo-bounding boxes for validation set.
        "metadata_roots_pseduo_boxs_valset": {},
        #############################
        # contains splits.
        ...
        ####for scm
        "scm_drop_rate": 0.0,  # float [0, 1] stochastic depth decay rule same value in SCM code
        "scm_drop_path_rate": 0.1,  # float [0, 1] drop path for stochastic depth same value in SCM code
        # ======================================================================
        #                          Segmentation mode
        # ======================================================================
        ...
        #for ablations
        'ablation_model_sele_l2_norm': False,  # Ablation: if true, we will selected model 
                                               #based on l2 norm of weigts.
        'ablation_model_sele_map_area': False, # Ablation: if true, we will select using 
                                               #area of when stabalizes over a window accross epochs.
        'abl_sele_map_area_var_window': constants.ABL_WINOW_MAP_SIZE_VAR[ds], # Ablation: window size (over epochs) for area variance.
    }
